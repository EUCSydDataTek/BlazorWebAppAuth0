Dette repository indeholder 4 projekter, som viser hvordan en Blazor Web App (.NET10) tilføjes authentication og authorization med Auth0, samt 2 projekter udvidet med Aspire:
